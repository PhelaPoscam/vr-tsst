...
public class PresentationTask : AbstractTask
{
    ...
    public override bool Next(Round round, bool secondRoundActive, bool secondRoundAvailable)
    {
        ...
        switch (_state)
        {
            case State.Inactive:
                ...
                return Next(round, secondRoundActive, secondRoundAvailable);
            case State.Welcome:
                if (statusOfTask.Equals("FirstOfFirstRound") || statusOfTask.Equals("FirstRoundOnlyTask") || statusOfTask.Equals("FirstRoundOnlyTaskOnlyRound") || statusOfTask.Equals("FirstRoundOnlyTaskNoAnnouncement"))
                {
                ...
                else if (statusOfTask.Equals("FirstOfSecondRound") || statusOfTask.Equals("SecondRoundOnlyTask"))
                {
                    ProfessorRitter.Instance.Overwrite = true;
            ...
            case State.ThanksAction:
                ...
                return false;
            default:
                Debug.LogError("[PresentationTask] Should not reach this switch branch.");
                return false;
        }
    }
    ...
    void WriteLogEntry()
    {
        ...
        string textToWrite = $"Current task: \"PresentationTask\"; Current state of Task: \"{_state.ToString()}\" at {System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss")}\r\n";

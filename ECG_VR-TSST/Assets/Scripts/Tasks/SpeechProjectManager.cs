...
public class SpeechProjectManager : AbstractTask
{
    ...
    public override bool Next(Round round, bool secondRoundActive, bool secondRoundAvailable)
    {
        ...
        switch (_state)
        {
            ...
            case State.ThanksAction:
                ...
                return false;
            default:
                Debug.LogError("[SpeechProjectManager] Should not reach this switch branch.");
                return false;
        }
    }
    ...
    void WriteLogEntry()
    {
        ...
        string textToWrite = $"Current task: \"SpeechProjectManager\"; Current state of Task: \"{_state.ToString()}\" at {System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss")}\r\n";
